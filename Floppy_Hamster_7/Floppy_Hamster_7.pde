...
SoundFile ambiente, punto, perdiste, ganaste, ouch, pop;
import fisica.*;
...
//
Hamster hamster;
Plataforma base1, base2, base3, base4, base6, base7, base8, base11;
...
void iniciarJuego() {
  ...
  semi1.inicializar(50, height-50);
  mundo.add(semi1);

  //Semi2
  Semilla semi2 = new Semilla();
  semi2.inicializar(90, height-50);
  mundo.add(semi2);


  //Semi3
  Semilla semi3 = new Semilla();
  semi3.inicializar(130, height-50);
  mundo.add(semi3);
...
void mousePressed() { //plataforma del hamster
  if (mouseX > 140 - 150/2 && mouseX < 140+150/2
    ...
    if (mouseX > 518 - 30/2 && mouseX < 518+30/2
      && mouseY >632 - 30/2 && mouseY < 632+30/2) {
      mundo.remove(base2);
      pop.play();
      pop.amp(0.2);
    } else { // to bola de polea
      if (mouseX > 340 - 150/2 && mouseX < 340+150/2
        && mouseY > 211 - 30/2 && mouseY < 211+30/2) {
        mundo.remove(base3);
        pop.play();
        pop.amp(0.2);
...
void contactStarted(FContact contact) {
  ...
  if (puntos>2 &&(_cuerpo1.getName() == "hamster" && _cuerpo2.getName() == "semilla")
    ...
    /*  for (int i=3; i < semillas.size(); i++)
     {
     semillas.get(i).agarrar();
     }*/
    ...
    ambiente.stop();
    ganar();
  } else if (puntos>2 &&(_cuerpo1.getName() == "hamster" && _cuerpo2.getName() == "semiEspe")
    || (_cuerpo2.getName() == "hamster" && (_cuerpo1.getName() == "semiEspe" ))) {
    println("colision");
