...
void setup() {
  ...
  libPuñete = loadImage("liberarpuñete.png");
  boxPuñete = loadImage("boxpuñete.PNG");
...
void iniciarJuego() {
  ...
  //Puñete
  FCircle puño = new FCircle(50);
  puño.setPosition(546, 195);
